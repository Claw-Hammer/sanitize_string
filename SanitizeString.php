...
class SanitizeString
{
     ...
     * @param bool $special
     * @return string $sanitized | $sanitizedSpecials
    **/
    private static function sanitize($newString, $special) {

        $replace_array = array('Š'=>'S', 'š'=>'s', 'Ž'=>'Z', 'ž'=>'z', 'À'=>'A', 'Á'=>'A', 'Â'=>'A', 'Ã'=>'A',
        ...
        if ($special == false) {
            ...
            $sanitizedSpecials = strtr($sanitized, $specialChars_array);
            return $sanitizedSpecials;
        }
    }
